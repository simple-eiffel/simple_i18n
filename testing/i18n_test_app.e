...
feature -- Tests
	...
	test_create_with_system_locale
		...
		local
			l_i18n: SIMPLE_I18N
		do
			print ("test_create_with_system_locale: ")
			...
			print ("OK (locale: " + l_i18n.locale_name.to_string_8 + ")%N")
		end
	...
	test_create_with_specific_locale
		...
		local
			l_i18n: SIMPLE_I18N
		do
			print ("test_create_with_specific_locale: ")
	...
	test_register_translation
		...
		local
			l_i18n: SIMPLE_I18N
		do
			print ("test_register_translation: ")
	...
	test_format_placeholders
		...
		local
			...
			l_result: STRING_32
		do
			print ("test_format_placeholders: ")
	...
	test_locale_info
		...
		local
			l_i18n: SIMPLE_I18N
		do
			print ("test_locale_info: ")

			create l_i18n.make

			-- These may vary by system, just verify they return something
			...
			print ("OK (decimal: '" + l_i18n.decimal_separator.to_string_8 +
				"', currency: '" + l_i18n.currency_symbol.to_string_8 + "')%N")
		end
