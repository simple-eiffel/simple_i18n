...
extern EIF_TYPED_VALUE F29_819(EIF_REFERENCE);
extern EIF_TYPED_VALUE F29_820(EIF_REFERENCE);
extern EIF_TYPED_VALUE F29_821(EIF_REFERENCE);
extern EIF_TYPED_VALUE F29_822(EIF_REFERENCE);
extern EIF_TYPED_VALUE F29_823(EIF_REFERENCE);
extern EIF_TYPED_VALUE F29_824(EIF_REFERENCE);
extern EIF_TYPED_VALUE F29_825(EIF_REFERENCE);
extern EIF_TYPED_VALUE F29_826(EIF_REFERENCE);
...
EIF_TYPED_VALUE F29_819 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F29_819,897,RTMS_EX_H("English",7,257590376));
}

/* {DATE_TIME_TOOLS}.days_text */
RTOID (F29_820)
EIF_TYPED_VALUE F29_820 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 28, Current, 0, 0, 897);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(28, Current, 897);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	...
	{
		static EIF_TYPE_INDEX typarr0[] = {401,0xFF01,275,0xFFFF};
		EIF_TYPE typres0;
...
RTOID (F29_821)
EIF_TYPED_VALUE F29_821 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 28, Current, 0, 0, 898);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(28, Current, 898);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(0, 0xF800018E, 0,0); /* Result */
...
RTOID (F29_822)
EIF_TYPED_VALUE F29_822 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 28, Current, 0, 0, 899);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(28, Current, 899);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(0, 0xF800018E, 0,0); /* Result */
...
RTOID (F29_823)
EIF_TYPED_VALUE F29_823 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 28, Current, 0, 0, 900);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(28, Current, 900);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(0, 0xF800018E, 0,0); /* Result */
...
EIF_TYPED_VALUE F29_824 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F29_824,902,RTMS_EX_H("[0]mm/[0]dd/yyyy",16,1621628025));
}
...
EIF_TYPED_VALUE F29_825 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F29_825,903,RTMS_EX_H("hh12:[0]mi:[0]ss.ff3 AM",23,629041741));
}
...
EIF_TYPED_VALUE F29_826 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F29_826,904,RTMS_EX_H("[0]mm/[0]dd/yyyy hh12:[0]mi:[0]ss.ff3 AM",40,2104244301));
}
