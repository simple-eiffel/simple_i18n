...
#define Result RTOTRB(EIF_CHARACTER_8)
	RTOTDB(EIF_CHARACTER_8, F22_526);
	dtype = Dtype(Current);
	...
	RTEAA(l_feature_name, 21, Current, 0, 0, 546);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	tc1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(531, dtype))(Current)).it_c1);
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 21, Current, 0, 0, 540);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(21, Current, 540);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
...
EIF_TYPED_VALUE F22_528 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 21, Current, 0, 0, 541);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 1);
	RTDBGEAA(21, Current, 541);
...
EIF_TYPED_VALUE F22_529 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 21, Current, 0, 0, 542);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 1);
	RTDBGEAA(21, Current, 542);
...
EIF_TYPED_VALUE F22_530 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 21, Current, 0, 0, 543);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 1);
	RTDBGEAA(21, Current, 543);
...
EIF_TYPED_VALUE F22_531 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 21, Current, 0, 0, 544);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 1);
	RTDBGEAA(21, Current, 544);
...
EIF_TYPED_VALUE F22_532 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 21, Current, 0, 0, 545);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 1);
