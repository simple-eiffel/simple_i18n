...
extern EIF_TYPED_VALUE F75_1468(EIF_REFERENCE);
extern EIF_TYPED_VALUE F75_1469(EIF_REFERENCE);
extern EIF_TYPED_VALUE F75_1470(EIF_REFERENCE);
...
EIF_TYPED_VALUE F75_1468 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F75_1469 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F75_1470 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 74, Current, 0, 0, 1498);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(74, Current, 1498);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	RTNHOOK(1,1);
	tr8_1 = *(EIF_REAL_64 *)(tr1 + RTVA(1371, "fractional_second", tr1));
