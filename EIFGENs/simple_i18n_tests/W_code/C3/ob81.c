...
extern EIF_TYPED_VALUE F81_1551(EIF_REFERENCE);
...
EIF_TYPED_VALUE F81_1551 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 80, Current, 0, 0, 1579);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(80, Current, 1579);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0xF800039E, 0,0); /* Result */
	{
		static EIF_TYPE_INDEX typarr0[] = {0xFF01,926,0xFF05,0,0xFFFF};
		EIF_TYPE typres0;
