...
extern EIF_TYPED_VALUE F459_3552(EIF_REFERENCE);
...
EIF_TYPED_VALUE F459_3552 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 458, Current, 0, 0, 3591);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(458, Current, 3591);
	RTIV(Current, RTAL);
