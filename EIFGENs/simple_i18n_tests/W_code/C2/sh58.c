...
extern EIF_TYPED_VALUE F58_1198(EIF_REFERENCE);
...
RTOID (F58_1198)
EIF_TYPED_VALUE F58_1198 (EIF_REFERENCE Current)
{
	GTCX
	char *l_feature_name = "plural_tools";
	RTEX;
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 57, Current, 0, 0, 1235);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(57, Current, 1235);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
