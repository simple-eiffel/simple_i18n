...
extern void F218_4589(EIF_REFERENCE);
extern EIF_TYPED_VALUE F218_4590(EIF_REFERENCE);
...
void F218_4589 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 217, Current, 2, 0, 8926);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(217, Current, 8926);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
RTOID (F218_4590)
EIF_TYPED_VALUE F218_4590 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 217, Current, 0, 0, 8927);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(217, Current, 8927);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
